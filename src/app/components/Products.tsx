    ...
    <section id="products" className="py-20 bg-muted">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="relative mb-20 bg-gradient-to-br from-accent/20 to-primary/10 rounded-3xl overflow-hidden shadow-2xl"
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 p-8 md:p-12 lg:p-16">
            <div className="flex flex-col justify-center">
              ...
              <div className="flex gap-4 mt-4">
                <button className="px-8 py-4 bg-primary text-white rounded-lg hover:bg-primary/90 transition-all duration-200 shadow-lg hover:shadow-xl">
                  Ver Detalhes
                </button>
              </div>
            </div>
